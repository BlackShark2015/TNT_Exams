...
CREATE TABLE IF NOT EXISTS `Materias` (
  `idMateria` INT NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `Complejidads` (
  `idComplejidad` INT NOT NULL COMMENT '',
  `Nombre` VARCHAR(45) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `TipoPreguntas` (
  `idTipoPreguntas` INT NOT NULL COMMENT '',
  `Nombre` VARCHAR(45) NULL COMMENT '',
  `Descripcion` VARCHAR(200) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `Preguntas` (
  `idPregunta` INT NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `Respuestas` (
  `idRespuestas` INT NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `DescripcionExamenes` (
  `idDescripcionExamen` INT NOT NULL COMMENT '',
